    ...
    public class BusquedaAccidentesService : IBusquedaAccidentesService
    {
            ...
            using (SqlConnection connection = new SqlConnection(_sqlClientConnectionBD.GetConnection()))
...

                {
                    ...
                    SqlCommand command = new SqlCommand("SELECT a.idAccidente, a.numeroReporte, a.fecha, a.hora, a.idMunicipio, a.idTramo, a.idCarretera, a.idElabora, a.idSupervisa, a.idAutoriza, a.kilometro, a.idOficinaDelegacion, "+                       
                        ...
                        "WHERE a.idOficinaDelegacion = @idOficina AND a.estatus=1 " +
        ...
        public List<BusquedaAccidentesModel> BusquedaAccidentes(BusquedaAccidentesModel model, int idOficina)
        {
            ...
            using (SqlConnection connection = new SqlConnection(_sqlClientConnectionBD.GetConnection()))
                ...
                {
                    connection.Open();
					string consulta = "SELECT a.idAccidente, a.numeroReporte, a.fecha, a.hora, a.idMunicipio, a.idTramo, " +
		"a.estatusReporte, a.idCarretera, a.idElabora, a.idSupervisa, a.idAutoriza, a.kilometro, a.idOficinaDelegacion, " +
		"mun.municipio, car.carretera, tra.tramo, er.estatusReporte AS estatusReporteDesc , er.idEstatusReporte, " +
		...
		"LEFT JOIN catOficiales AS aut ON a.idAutoriza = aut.idOficial ";
					...
					consulta += "WHERE " +
						"a.idOficinaDelegacion = @idOficina AND " +
						"a.estatus = 1 AND " +
						"((vea.placa = @placasBusqueda) OR " +
						"UPPER(a.numeroReporte) = @oficioBusqueda OR " +
						"a.idAutoriza = @idOficialBusqueda OR " +
						"a.idSupervisa = @idOficialBusqueda OR " +
						"a.idAutoriza = @idOficialBusqueda OR " +
						"a.idCarretera = @idCarreteraBusqueda OR " +
						"a.idTramo = @idTramoBusqueda OR " +
						"a.estatusReporte = @idEstatusReporte OR " +
						"UPPER(prop.nombre) = @propietarioBusqueda OR " +
						"UPPER(prop.apellidoPaterno) = @propietarioBusqueda OR " +
						"UPPER(prop.apellidoMaterno) = @propietarioBusqueda OR " +
						"UPPER(cond.nombre) = @conductorBusqueda OR " +
						"UPPER(cond.apellidoPaterno) = @conductorBusqueda OR " +
						"UPPER(cond.apellidoMaterno) = @conductorBusqueda OR " +
						"vea.serie = @serieBusqueda" +
						((model.FechaInicio != DateTime.MinValue && model.FechaFin != DateTime.MinValue)
							? $" AND (a.fecha BETWEEN @fechaInicio AND @fechaFin)"
							: "") +
						") " +
						"GROUP BY " +
						"a.idAccidente, a.numeroReporte, a.fecha, a.hora, a.idMunicipio, a.idTramo, a.estatusReporte, a.idCarretera, " +
						"a.idElabora, a.idSupervisa, a.idAutoriza, a.kilometro, a.idOficinaDelegacion, " +
						"mun.municipio, car.carretera, tra.tramo, er.estatusReporte, er.idEstatusReporte, ela.idOficial, sup.idOficial, aut.idOficial";
					...
					{
						command.CommandType = CommandType.Text;
						command.Parameters.Add(new SqlParameter("@fechaInicio", SqlDbType.DateTime)).Value = (model.FechaInicio != DateTime.MinValue) ? (object)model.FechaInicio : DBNull.Value;
						command.Parameters.Add(new SqlParameter("@fechaFin", SqlDbType.DateTime)).Value = (model.FechaFin != DateTime.MinValue) ? (object)model.FechaFin : DBNull.Value;
						command.Parameters.Add(new SqlParameter("@idOficina", SqlDbType.Int)).Value = (object)idOficina ?? DBNull.Value;
