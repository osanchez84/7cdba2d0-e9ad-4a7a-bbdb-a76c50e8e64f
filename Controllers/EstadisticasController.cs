...
namespace GuanajuatoAdminUsuarios.Controllers
{
    ...
    public class EstadisticasController : BaseController
    {
        ...
        public JsonResult Delegaciones_DropExt2()
        {
            ...
            var result = new SelectList(_catDelegacionesOficinasTransporteService.GetDelegacionesFiltrado(idDependencia), "IdOficinaTransporte", "NombreOficina");
            return Json(result);
        }
        ...
        public IActionResult ActualizarViewBag(IncidenciasBusquedaModelEstadisticas model)
        {
            ...
            //ViewBag.GridInfracciones = modelGridInfracciones;
            return PartialView("_GridInfracciones", modelGridInfracciones);
        }
